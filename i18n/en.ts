...
const en: Translation = {
  ...
  payment: {
    ...
    postcodePlaceholder: "Postal code (optional)",
    addressPlaceholder: "Enter your address",
    addressDetailPlaceholder: "Address detail (unit, floor — optional)",
    shippingPreparing: "Preparing",
    ...
    orderTitle: "Checkout",
    ordererInfo: "Buyer information",
    consentTitle: "Guest personal data collection & use consent",
    consentBody:
      "1. Items collected: name, mobile number, email (optional), recipient, shipping address, landline (optional), delivery message (optional)\n2. Purpose: guest order confirmation, payment processing, product delivery and delivery notices\n3. Retention: kept for 5 years under applicable e-commerce consumer-protection law, then destroyed\n4. You may refuse consent, but guest ordering and delivery are unavailable without it.",
    consentAgree: "I agree",
    shippingInfoTitle: "Shipping information",
    recipientLabel: "Recipient",
    recipientPlaceholder: "Recipient name",
    telLabel: "Landline (optional)",
    telPlaceholder: "e.g. 0212345678",
    deliveryMsgLabel: "Delivery message (optional)",
    deliveryMsgPlaceholder: "e.g. Please leave with the doorman if absent",
    payNow: "Pay now",
    backToProduct: "Back",
    ...
    needInfo:
      "Please fill in buyer info (name & phone), recipient & shipping address, and agree to the personal data terms to proceed.",
